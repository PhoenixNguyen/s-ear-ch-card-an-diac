...
!function ($) {
    ...
    var DateRangePicker = function (element, options, cb) {
        ...
        var isEn = (document.cookie + '').indexOf("ver=en") >= 0;
        this.locale = {
            applyLabel: isEn ? 'Apply' : 'Chọn',
            clearLabel: isEn ? 'Cancel' : 'Hủy',
            fromLabel: isEn ? 'From' : 'Từ',
            toLabel: isEn ? 'To' : 'Đến',
            weekLabel: 'W',
            customRangeLabel: isEn?'Custom':'Tùy chọn',
