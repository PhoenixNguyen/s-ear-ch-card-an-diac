				...
				<div id="w_body">
					<div class="row_sub">
						...
						<div class="right_content">
							...
							<form action="mo-analytics.html" method="get" name="filter_histogram">
							<div class="box_locketqua">
									...
									<div class="filter_row">
										<fieldset class="fieldset_filter" style="margin-left: 0px;">
											<legend>
												<input type="checkbox" name="providerAll" value="providerAll" id="providerAll" class="chck_filter" ${fn:contains(param.providerAll,'providerAll')?'checked="checked"':'' }  /> Nhà cung cấp
												<script type="text/javascript">
							...
							<!-- Statisic chart -->
							<!-- LINE CHART -->
							<jsp:include page="mo-chart.js.gg.jsp" />
										...
										<div class="srv_row1" style="width: 100%;">
											...
											<script type="text/javascript">
												...
												$(document).ready(function(){
													...
													$('table .toggle').live('click', function(){
														...
														if(toggle == false){
														    $('.btn_graytoggle').html('Thu lại');
														}
														else{
															$('.btn_graytoggle').html('Thêm');
														}
											...
											<c:choose>
												<c:when test="${model.topData.size() > 0}">
													<fieldset class="fieldset_filter" style="width: 35%; float: left; border: none; display: inline-block;">
														<span class="pie">
															<div id="pie_chart" class="pie_child_inline" style="width: 350px; height: 350px;">
															</div>
														</span>
													</fieldset>
													
													<fieldset class="fieldset_filter" style="width: 40%; float: right; border: none; display: inline-block;">
														<table width="100%">
															<tr>
																<th>Stt</th>
																<c:choose>
															...
															<tr>
																<td class="toggle " colspan="5"><span class="btn_graytoggle">Thêm</span></td>
															</tr>
														</table>
													</fieldset>
												</c:when>
