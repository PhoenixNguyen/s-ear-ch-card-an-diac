...
@Document(indexName = "mo-indexes", type = "mo-index", shards = 1, replicas = 0, refreshInterval = "-1", indexStoreType = "fs")
public class ESSMS {
	/*
	 * comman code - gamcode
		short code 9029
	...
	public ESSMS(){}
	public ESSMS(String id, String merchant, String app_id, String provider, String telco, String msisdn, int amount,
