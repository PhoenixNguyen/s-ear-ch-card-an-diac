					...
					<div class="row_sub">
						...
						<div class="right_content">
							...
							<span style="display: block; float: right; margin-top: 10px">
							    <label>Đường giới hạn</label>  
							    <input id="limit" name="limit" type="number" value="${param.limit }" class="text_filter" style="width: 50px; padding: 2px; text-align: right;"/>
											...
											<c:choose>
												<c:when test="${model.topData.size() > 0}">
													<fieldset class="fieldset_filter" style="width: 15%; float: left; border: none; display: inline-block;">
														<span class="pie">
															<div id="pie_chart" class="pie_child_inline" style="width: 260px; height: 260px;">
															</div>
														</span>
													</fieldset>
